...
class StoreController extends GetxController {
  ...
  Future<void> onInit() async {
    ...
    await getStoreData(id: "62ecd65432b98125b880da75", businessId: '');
          ...
          for (GetCartIdProducts allCartProducts
            ...
            for (MainProducts mainProducts
              ...
              if (index != -1) {
                ...
                totalItemsCount = getCartIDModel.value?.totalItemsCount ?? 0;
        ...
        for (MainProducts mainProducts
          ...
          if (index != -1) {
            getCartIDModel.value?.totalItemsCount =
                addToCartModel.value?.totalItemsCount;
            totalItemsCount = addToCartModel.value?.totalItemsCount ?? 0;
