                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                boxShadow: [
                                  BoxShadow(
                                    color: (_myAccountController.activeOrders.data?.isNotEmpty ?? false) ? AppConst.grey : AppConst.transparent,
                                    blurRadius: 5.0,
                                  ),
                                ],
                                color: (_myAccountController.activeOrders.data?.isNotEmpty ?? false) ? AppConst.lightYellow : AppConst.transparent,
                              ),
                              child: Padding(
                                padding: EdgeInsets.symmetric(horizontal: 2.w),
                                child: Row(
                                  ...
                                  children: [
                                    Obx(
                                      () => (_myAccountController.activeOrders.data?.isNotEmpty ?? false)
                                          ? GestureDetector(
                                              onTap: () {
