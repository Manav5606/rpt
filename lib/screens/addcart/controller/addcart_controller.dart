...
class AddCartController extends GetxController {
  ...
  Future<void> getOrderConfirmPageData({required String storeId, required double distance, required double walletAmount, var products}) async {
    try {
      isLoading.value = true;
      getOrderConfirmPageDataModel.value =
          await AddCartService.getOrderConfirmPageData(storeId: storeId, distance: distance, walletAmount: walletAmount, products: products);
