...
class HistoryOrderItems extends StatelessWidget {
  final ChatController _chatController = Get.find();
  final freshChatController _freshChat = Get.find();
  final OrderData? order;
  var TimeSlot;
  HistoryOrderItems({Key? key, this.order, this.TimeSlot}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            (order?.orderType == "receipt" && order?.status == "completed")
                ? SizedBox(
                    height: 2.h,
                  )
                : InkWell(
            ...
            AllFoundedItems(order: order),
            AllReplacedItems(order: order),
            AllModifiedItems(order: order),
          ],
        ),
      ),
    );
    ...
    return foundItemCount != 0
        ? Column(
            children: [
              ...
              (order?.products?.where((c) => c.status == "modified").toList() ==
                          null ||
                      order?.products
                              ?.where((c) => c.status == "modified")
                              .toList()
                  ...
                  : ListView.separated(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return ModifiedItemsList(
                          ...
                          updatequantity:
                              (order?.products?[index].updatequantity),
                          units: "125gm",
                        );
                      },
                  ...
                  : ListView.separated(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return ModifiedItemsList(
                          ...
                          quantity: (order?.inventories?[index].quantity),
                          updatequantity:
                              (order?.inventories?[index].updatequantity),
                          units: "125gm",
                        );
                      },
                      separatorBuilder: (BuildContext context, int index) =>
                          SizedBox()),
              (order?.rawItems?.where((c) => c.status == "modified").toList() ==
                          null ||
                      order?.rawItems
                              ?.where((c) => c.status == "modified")
                              .toList()
                  ...
                  : ListView.separated(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return ModifiedItemsList(
                          ...
                          quantity: (order?.rawItems?[index].quantity),
                          updatequantity:
                              (order?.rawItems?[index].updatequantity),
                          units: "125gm",
                        );
                      },
                      separatorBuilder: (BuildContext context, int index) =>
              ...
              Column(
                ...
                children: [
                  ...
                  RichText(
                    ...
                    TextSpan(
                        text:
                            "${quantity ?? 0}", // " ${(order?.products?[index].quantity ?? 0)} ",
                        style: TextStyle(
    ...
    return foundItemCount != 0
        ? Column(
            children: [
              ...
              (order?.products?.where((c) => c.status == "replaced").toList() ==
                          null ||
                      order?.products
                              ?.where((c) => c.status == "replaced")
                              .toList()
                  ...
                  : ListView.separated(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return ReplaceItemsList(
                          name: order?.products?[index].name,
                          quantity: order?.products?[index].quantity,
                          updatename: order?.products?[index].updatename,
                          updatequantity:
                              order?.products?[index].updatequantity,
                          units: "300gm",
                        );
                  ...
                  : ListView.separated(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return ReplaceItemsList(
                          name: order?.inventories?[index].name,
                          quantity: order?.inventories?[index].quantity,
                          updatename: order?.inventories?[index].updatename,
                          updatequantity:
                              order?.inventories?[index].updatequantity,
                          units: "300gm",
                        );
              ...
              (order?.rawItems?.where((c) => c.status == "replaced").toList() ==
                          null ||
                      order?.rawItems
                              ?.where((c) => c.status == "replaced")
                              .toList()
                  ...
                  : ListView.separated(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return ReplaceItemsList(
                          name: order?.rawItems?[index].item,
                          quantity: order?.rawItems?[index].quantity,
                          updatename: order?.rawItems?[index].updatename,
                          updatequantity:
                              order?.rawItems?[index].updatequantity,
                          units: "300gm",
                        );
    ...
    return foundItemCount != 0
        ? Column(
            children: [
              ...
              (order?.products?.where((c) => c.status == "found").toList() ==
                          null ||
                      order?.products
                              ?.where((c) => c.status == "found")
                              .toList()
                  ...
                  : ListView.separated(
                      ...
                      separatorBuilder: (BuildContext context, int index) =>
                          SizedBox()),
              (order?.rawItems?.where((c) => c.status == "found").toList() ==
                          null ||
                      order?.rawItems
                              ?.where((c) => c.status == "found")
                              .toList()
                  ...
                  : ListView.separated(
                      ...
                      separatorBuilder: (BuildContext context, int index) =>
                          SizedBox()),
              (order?.inventories?.where((c) => c.status == "found").toList() ==
                          null ||
                      order?.inventories
                              ?.where((c) => c.status == "found")
                              .toList()
    ...
    return foundItemCount != 0
        ? Column(
            children: [
              ...
              (order?.products?.where((c) => c.status == null).toList() ==
                          null ||
                      order?.products
                              ?.where((c) => c.status == null)
                              .toList()
                  ...
                  : ListView.separated(
                      ...
                      separatorBuilder: (BuildContext context, int index) =>
                          SizedBox()),
              (order?.rawItems?.where((c) => c.status == null).toList() ==
                          null ||
                      order?.rawItems
                              ?.where((c) => c.status == null)
                              .toList()
                  ...
                  : ListView.separated(
                      ...
                      separatorBuilder: (BuildContext context, int index) =>
                          SizedBox()),
              (order?.inventories?.where((c) => c.status == null).toList() ==
                          null ||
                      order?.inventories
                              ?.where((c) => c.status == null)
                              .toList()
