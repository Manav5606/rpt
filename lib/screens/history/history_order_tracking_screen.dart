...
class HistoryOrderTrackingScreen extends StatelessWidget {
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              ViewOrderDetailsTextfeilds(
                                  "CashBack", order?.total_cashback ?? 0),
                              Container(
                                height: 0.5,
                                color: AppConst.lightGrey,
                              ),
                              ViewOrderDetailsTextfeilds(
                                  "Amount Paid", order?.wallet_amount ?? 0),
                              Container(
                                height: 0.5,
                                color: AppConst.lightGrey,
                              ),
                                        ...
                                        Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                "Order Total- \u{20B9} ${order?.total ?? 0}",
                                                style: TextStyle(
                                                    fontSize: SizeUtils
                                                            .horizontalBlockSize *
                                                        4,
  ...
  Padding ViewOrderDetailsTextfeilds(String? text, num? amount) {
    return Padding(
