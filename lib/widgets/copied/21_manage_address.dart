...
import 'package:customer_app/config/localStorage.dart';
...
class ManageAddress extends StatelessWidget {
  ...
  const ManageAddress(
      {this.showAddAddress: true, required this.onAddressSelect, Key? key})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: mapIndexed<Widget, AddressModel>(
          UserViewModel.user.value.addresses!, (index, item) {
        ...
        return GestureDetector(
          onTap: () {
            ...
            UserViewModel.setLocation(
                LatLng(data.location!.lat!, data.location!.lng!), data.id);
        ...
        ..add(Visibility(
          ...
          child: GradientButton(
            ...
            fontStyle: TextStyle(color: AppConst.white),
          ),
        )),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          border: Border.all(
              color: selected ? AppConst.themeBlue : AppConst.lightGrey,
              width: 1),
          boxShadow: [
            BoxShadow(
                offset: Offset(0, 12),
        ...
        children: [
          ...
          Flexible(
            child: Column(
              ...
              children: [
                Text('${addressType.trim().capitalize}',
                        ...
                        return GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                color: AppConst.white,
                                border: Border.all(
                                    color: AppConst.lightGrey, width: 1),
                                boxShadow: [
                                  BoxShadow(
                                      offset: Offset(0, 12),
                                      blurRadius: 12,
