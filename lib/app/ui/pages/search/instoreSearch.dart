        ...
        leading: Padding(
          ...
          child: InkWell(
            onTap: () async {
              ...
              _moreStoreController.autoCompleteProductsByStoreModel.value?.data?.inventories?.clear();
        ...
        actions: [
          Obx(
            () => CartWidget(
              ...
              count: "${_moreStoreController.addToCartModel.value?.totalItemsCount ?? 0}",
            ),
          ),
        ],
        title: Column(
          ...
          Obx(
            () => TextField(
              ...
              decoration: InputDecoration(
                  isDense: true,
                  suffixIcon: (_moreStoreController.storeSearchText.value.isEmpty)
                      ? Icon(
                          Icons.search,
                      ...
                      : IconButton(
                          onPressed: () {
                            ...
                            _moreStoreController.storeSearchController.clear();
                            _moreStoreController.storeSearchText.value = '';
                            _moreStoreController.autoCompleteProductsByStoreModel.refresh();
                          },
                          icon: Icon(
                            Icons.cancel,
                            color: AppConst.black,
              ...
              onChanged: (value) {
                ...
                _moreStoreController.storeSearchText.value.isNotEmpty
                    ? _moreStoreController.getAutoCompleteProductsByStore(name: value, storeId: storeID)
                    : _moreStoreController.getAutoCompleteProductsByStore(name: " ", storeId: storeID);
                // onSearch(value);
              },
            ),
          ),
          ...
          Expanded(
            child: SingleChildScrollView(
              child: Column(
                ...
                mainAxisAlignment: MainAxisAlignment.start,
                children: [
                  Obx(() => (_moreStoreController.autoCompleteProductsByStoreModel.value?.data?.products?.isNotEmpty ?? false)
                      ? StoreProductSearchList(
                          foundedStores: _moreStoreController.autoCompleteProductsByStoreModel.value?.data?.products,
                        )
                      : SizedBox()),
                  Obx(
                    () => (_moreStoreController.autoCompleteProductsByStoreModel.value?.data?.inventories?.isNotEmpty ?? false)
                        ? Column(
                            children: [
                              Padding(
                              ...
                              Inventories(
                                inventoriesModel: _moreStoreController.autoCompleteProductsByStoreModel.value?.data?.inventories,
                              )
                            ],
                          )
                        : SizedBox(),
