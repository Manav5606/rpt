  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
        minimum: EdgeInsets.only(
            top: SizeUtils.horizontalBlockSize * 3.82, left: SizeUtils.horizontalBlockSize * 2.55, right: SizeUtils.horizontalBlockSize * 2.55),
        child: Scaffold(
          body: Column(
            children: [
              Container(
                ...
                decoration: BoxDecoration(color: AppConst.white, boxShadow: [
                  BoxShadow(color: AppConst.grey.withOpacity(0.5), spreadRadius: -3, blurRadius: 5, offset: Offset(0, 6)),
                ]),
              ),
              ...
              Container(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(color: AppConst.green, borderRadius: BorderRadius.circular(SizeUtils.horizontalBlockSize * 5)),
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceAround,
                    children: [
                      FittedBox(
                        ...
                        child: Text(
                          "Go to Checkout",
                          style: TextStyle(color: AppConst.white, fontSize: SizeUtils.horizontalBlockSize * 5),
                          overflow: TextOverflow.ellipsis,
                        ),
                      ),
                      Container(
                        ...
                        decoration:
                            BoxDecoration(color: AppConst.kSecondaryColor, borderRadius: BorderRadius.circular(SizeUtils.horizontalBlockSize * 5)),
                        child: FittedBox(
                          fit: BoxFit.scaleDown,
                          child: Text(
                            "\$25",
