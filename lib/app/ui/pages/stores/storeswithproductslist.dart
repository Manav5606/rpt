...
class ListViewChild extends StatelessWidget {
  ...
  ListViewChild({Key? key, required this.storesWithProductsModel}) : super(key: key);
    ...
    return Padding(
      ...
      child: Column(
        children: [
          InkWell(
            onTap: () async {
              _moreStoreController.storeId.value = storesWithProductsModel.sId ?? '';
              ...
              children: [
                storesWithProductsModel.logo!.isEmpty
                    ? Padding(
                        ...
                        child: CircleAvatar(
                          child: Text(storesWithProductsModel.name?.substring(0, 1) ?? "",
                              style: TextStyle(fontSize: SizeUtils.horizontalBlockSize * 6)),
                    ...
                    : Padding(
                        ...
                        child: CircleAvatar(
                          backgroundImage: NetworkImage(storesWithProductsModel.logo!),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      if (storesWithProductsModel.storeType?.isNotEmpty ?? false)
                        if ((storesWithProductsModel.storeType ?? '') == 'online')
                          Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              ...
                              (storesWithProductsModel.calculatedDistance != null)
                                  ? Container(
                                      ...
                                      decoration: BoxDecoration(borderRadius: BorderRadius.circular(4), border: Border.all(color: AppConst.grey)),
                                      child: Text("${(storesWithProductsModel.calculatedDistance!.toInt() / 1000).toStringAsFixed(2)} km away",
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            Products product = storesWithProductsModel.products![index];
                            return Container(
                              width: 40.w,
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
