...
class MyAccountController extends GetxController {
  ...
  formatDate() {
    ...
    if (currentDay.value == activeOrders.data?[selectIndex.value].deliverySlot?.day.toString()) {
      displayHour.value = activeOrders.data?[selectIndex.value].deliverySlot?.startTime?.hour.toString() ?? "";
      var endtime = activeOrders.data?[selectIndex.value].deliverySlot?.endTime?.hour.toString() ?? "";
  ...
  getActiveOrders() async {
    MyAccountRepository.getAllActiveOrders().then((value) => this.activeOrders = value);
  }
