...
class SizeUtils {
  ...
  void init(BuildContext context) {
    ...
    horizontalBlockSize = screenWidth! / (SizerUtil.deviceType == DeviceType.mobile ? 100 : 150);
    verticalBlockSize = screenHeight! / (SizerUtil.deviceType == DeviceType.mobile ? 100 : 150);
